...
namespace DapperRepository
{
        ...
        where TPoco : class
    {
        ...
        Task<List<TPoco>> FindAllAsync(IDbConnection conn = null, IDbTransaction transaction = null);
        Task<List<TPoco>> SelectAsync(string sql, object param = null, IDbConnection conn = null, IDbTransaction transaction = null);
